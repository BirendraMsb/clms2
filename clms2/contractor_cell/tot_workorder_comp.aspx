<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tot_workorder_comp.aspx.cs" Inherits="clms2.contractor_cell.tot_workorder_comp" %>
                        ...
                        <div class="page-content-tab">
                            <div class="container-fluid">
                                ...
                                <div class="card shadow border">
                                    <div class="card-heading bg-dark text-white p-2 d-flex justify-content-between">Total Work Order Commplience </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row" style="width: 1000px">
                                            <div class="col-md-2">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <asp:DropDownList ID="ddlVendorCode" class="form-control" runat="server" Visible="True" MaxLength="50">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                        ...
                                        <div>
                                            <div class="table-responsive" style="overflow: auto;">
                                                ...
                                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                                                    GridLines="Vertical" PageSize="5" DataKeyNames="vendor_code" EmptyDataText="No records has been added."
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Vendor No" ItemStyle-Width="50px">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Total Employee" ItemStyle-Width="50px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="tot_emp" runat="server" Text='<%# Eval("tot_emp") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle Width="50px" />
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Daily-rate of wages/rate" ItemStyle-Width="50px" Visible="False">
                                                            <ItemTemplate>
                                                                <asp:Label ID="daily_rate_of_wages" runat="server" Text='<%# Eval("daily_rate_of_wages") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle Width="50px" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Basic wages" ItemStyle-Width="50px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Basic" runat="server" Text='<%# Eval("Basic") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle Width="50px" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Dearness Allowances" Visible="false" ItemStyle-Width="50px">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Other cash payment" ItemStyle-Width="50px">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="UAN Deduction" ItemStyle-Width="50px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="pf_deduction" runat="server" Text='<%# Eval("pf_deduction") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle Width="50px" />
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="ESIC Deduction" ItemStyle-Width="50px">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Net Amount Paid" ItemStyle-Width="50px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="net_amount_paid" runat="server" Text='<%# Eval("net_amount_paid") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle Width="50px" />
                                                        </asp:TemplateField>
