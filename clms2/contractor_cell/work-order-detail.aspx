<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="work-order-detail.aspx.cs" Inherits="clms2.contractor_cell.work_order_detail" %>
                ...
                <td>
                    <div class="page-wrapper">
                        <div class="page-content-tab">
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive" style="overflow: auto;">
                                         <%--   <p style="text-align: center">
                                                ...
                                                <asp:Button ID="btnSearch" Visible="false" runat="server" Text="Search" OnClick="btnSearch_Click" /><br />
                                            </p>--%>
                         ...
                         <ItemStyle Width="250" /></asp:BoundField>--%>
