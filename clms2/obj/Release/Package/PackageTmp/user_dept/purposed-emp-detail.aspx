<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="purposed-emp-detail.aspx.cs" Inherits="clms2.user_dept.purposed_emp_detail" %>
...
<asp:Button ID="UncheckAll" runat="server" Text="Uncheck All" />--%>
                                            ...
                                            <asp:GridView ID="GvEmp" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                                                GridLines="Vertical" OnPageIndexChanging="GvEmp_PageIndexChanging" AllowPaging="true" PageSize="10" DataKeyNames="id" Class="table table-bordered nowrap" ShowHeaderWhenEmpty="true" OnRowCancelingEdit="GvEmp_RowCancelingEdit" OnRowEditing="GvEmp_RowEditing" OnRowUpdating="GvEmp_RowUpdating" OnRowDataBound="GvEmp_RowDataBound">
