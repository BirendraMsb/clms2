<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllowancesMaster.aspx.cs" Inherits="clms2.vendor_onboarding.AllowancesMaster" %>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive" style="overflow: auto;">
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                                                ...
                                                OnRowUpdating="OnRowUpdating" EmptyDataText="No Approved records has been added."
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:CommandField ButtonType="Button" HeaderText="Action" ControlStyle-BackColor="#99ccff" ControlStyle-Font-Bold="true" ShowEditButton="true"
                                                        ItemStyle-Width="150">
                                                        <ItemStyle Width="150px" />
