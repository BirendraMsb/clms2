...
namespace clms2.contractor_cell
{
    public partial class work_order_detail : System.Web.UI.Page
    {
        ...
        {
            dbConnection();
            strSQL = "SELECT a.*,b.vendor_name,b.vendor_reg_code,b.pano,b.gstno,b.pfno,b.esicno FROM tbl_vendor_work_order a, tbl_vendor_info b where a.vendor_reg_code=b.vendor_reg_code and a.work_worder=b.work_worder and b.status='P' order by id desc "; 
            //////if (txtSearch.Text == "")
        ...
        protected void GvWod_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            //////if (DataBinder.Eval(e.Row.DataItem, "status") == "N" & chk == "awo")
            //////    e.Row.BackColor = System.Drawing.Color.LightSalmon;
            //////else
            //////{
            //////}
