<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="shift-master.aspx.cs" Inherits="clms2.vendor_onboarding.shift_master" %>
                        ...
                        <div class="page-content-tab">
                            <div class="container-fluid">
                                ...
                                <div class="card shadow border">
                                    <div class="card-heading bg-dark text-white p-2 d-flex justify-content-between">Create Shift </div>
                                    <div class="card-body">
                                            ...
                                            <%--  <div class="col-md-2">
                                                <div class="form-group mb-3">
                                                       <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                        <ContentTemplate>
                                                            <label>2nd Week Off</label>
                                                             <asp:DropDownList ID="ddlWeekOff2" class="form-control" runat="server">
                                                              <asp:ListItem>Saturday</asp:ListItem>
                                                              <asp:ListItem>Sanday</asp:ListItem>
                                                          </asp:DropDownList> 
                                                        </ContentTemplate>
                                                    </asp:UpdatePanel>
                                                </div>
