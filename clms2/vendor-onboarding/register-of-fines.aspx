<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="register-of-fines.aspx.cs" Inherits="clms2.vendor_onboarding.register_of_fines" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div class="text-center">
                <h6 class="mb-0">FORM XXI</h6>
                <h6 class="my-0">1[See rule 78 (1) a) (ii)]</h6>
                <h5 class="my-0">Register of Fines</h5>
            </div>
            <div class="row">
                <div class="col-md-6">
                                ...
                                <div class="table-responsive" style="overflow: auto;">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="4. Designation/Nature of employment" ItemStyle-Width="150">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="5. Act/Omission for which fine imposed" ItemStyle-Width="150">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblOmissionFineImpose" runat="server" Text='<%# Eval("emp_name")%>'></asp:Label>
                                                </ItemTemplate>
                                                <%-- <EditItemTemplate>
                                                            <asp:TextBox ID="txtEmpName" runat="server" Text='<%# Eval("emp_name")%>' Width="140"></asp:TextBox>
                                                        </EditItemTemplate>--%>
                                            ...
                                            <asp:TemplateField HeaderText="6. Date of offence " ItemStyle-Width="150">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblDtOffence" runat="server" Text='<%# Eval("skill_category")%>'></asp:Label>
                                                </ItemTemplate>
                                                <%--  <EditItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="7. Whether workman showed cause against fine" ItemStyle-Width="150">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCauseAgnsFine" runat="server" Text='<%# Eval("basic")%>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="150px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="8.   Name of  person in whose presence employee's explanation was heard" ItemStyle-Width="150">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblNamePresEmp" runat="server" Text='<%# Eval("allowance")%>'></asp:Label>
                                                </ItemTemplate>

                                                <ItemStyle Width="150px" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="9. Wage periods and wages payable" ItemStyle-Width="150">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblWagePeriod" runat="server" Text='<%# Eval("other_deduction")%>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="150px" />
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="10. Amount of fine Imposed" ItemStyle-Width="150">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAmtFineEmpose" runat="server" Text='<%# Eval("other_deduction")%>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="150px" />
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="11. Date on which fine realized" ItemStyle-Width="150">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblFineRealize" runat="server" Text='<%# Eval("other_deduction")%>'></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle Width="150px" />
                                            </asp:TemplateField>
