<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manual-punching.aspx.cs" Inherits="clms2.admin.manual_punching" %>
                                       ...
                                       <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    <label>In Out</label>
                                                    <asp:DropDownList ID="ddlInOut" class="form-control" runat="server">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <asp:TextBox ID="txtFromDate" runat="server" class="form-control" MaxLength="50" TextMode="Date"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                         <div class="row">
                                         ...
                                         <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    <label>In Time</label>
                                                    <asp:TextBox ID="txtInTime" runat="server" class="form-control" MaxLength="50" TextMode="Time"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                       ...
                                       <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <asp:TextBox ID="txtOutTime" runat="server" class="form-control" MaxLength="50" TextMode="Month"></asp:TextBox>
                                                </div>
                                            </div>
                                        </div>
                                        <hr class="my-3" />                      
