<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="form16.aspx.cs" Inherits="clms2.vendor_onboarding.form16" %>
                        ...
                        <div class="page-content-tab">
                            <div class="container-fluid">
                                ...
                                <div class="card shadow border">
                                    <div class="card-heading bg-dark text-white p-2 d-flex justify-content-between">Form XVI </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10 text-center">
                                                <div class="form-group mb-3">
                                                    <p class="align-content-center">FORM XVI </p>
                                                    <p class="align-content-center">1[See rule 78 (1) (a) (i)]</p>
                                                    <p class="align-content-center">Muster roll</p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="table-responsive" style="overflow: auto;">
                                                ...
                                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Out Time" ItemStyle-Width="100px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="date" runat="server" Width="100px" Text='<%# Eval("date","{0:dd-MM-yyyy}") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle Width="100px" />
