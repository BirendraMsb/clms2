<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="generate-shift.aspx.cs" Inherits="clms2.vendor_onboarding.generate_shift" %>
                        ...
                        <div class="page-content-tab">
                            <div class="container-fluid">
                                ...
                                <div class="card shadow border">
                                    <div class="card-heading bg-dark text-white p-2 d-flex justify-content-between">Generate Shift </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <asp:Button ID="cmdShow" runat="server" Text="Back" Width="150px" class="btn btn-info" OnClick="cmdShow_Click"></asp:Button>
                                        ...
                                        <div class="row" style="width: 1000px">
                                            <div class="col-md-2">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <asp:DropDownList ID="ddlWorkOrderNo" runat="server" class="form-control" Width="100px" AutoPostBack="True" OnSelectedIndexChanged="ddlWorkOrderNo_SelectedIndexChanged"></asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group mb-3">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <asp:DropDownList ID="ddlEmpCode" class="form-control" runat="server" Visible="false" MaxLength="50" AutoPostBack="True" OnSelectedIndexChanged="ddlEmpCode_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                ...
                                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Department" ItemStyle-Width="50px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="department" runat="server" Width="50px" Text='<%# Eval("department") %>'></asp:Label>
                                                            </ItemTemplate>
                                                            <ItemStyle Width="50px" />
                                                        </asp:TemplateField>
