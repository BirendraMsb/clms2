<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="leave-master.aspx.cs" Inherits="clms2.vendor_onboarding.leave_master" %>
                                        ...
                                        <div class="table-responsive" style="overflow: auto;">
                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Leave Code" ItemStyle-Width="150">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Leave Type" ItemStyle-Width="150">
                                                        <ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderText="Paid" ItemStyle-Width="150">
                                                        <ItemTemplate>
