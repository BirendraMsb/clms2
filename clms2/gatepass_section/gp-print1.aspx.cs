...
{
    public partial class gp_print1 : System.Web.UI.Page
    {
        private int rcnt;
        ...
        protected void txtSearch_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                if ((IsPostBack))
                {
                    ...
                    strSQL = "SELECT tbl_vendor_work_order.vendor_reg_code, tbl_vendor_work_order.work_worder, tbl_vendor_work_order.valid_from, tbl_vendor_work_order.valid_to, tbl_emp.emp_name, tbl_emp.gender, tbl_emp.dob, tbl_emp.blood_grp," +
                            ...
                            "tbl_vendor_info ON tbl_emp.workorderno = tbl_vendor_info.work_worder where tbl_emp.emp_code='" + txtSearch.SelectedValue + "'";
