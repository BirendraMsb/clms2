<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="form17.aspx.cs" Inherits="clms2.vendor_onboarding.form17" %>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-10 text-center">
                                                <div class="form-group mb-3">
                                                    <p class="align-content-center">FORM XVII </p>
                                                    <p class="align-content-center">1[See rule 78 (1) (a) (i)]</p>
                                                    <p class="align-content-center">Register of Wages</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row" style="width: 1000px">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group mb-3">
                                                    <label>Month</label>
                                                    <asp:DropDownList ID="ddlMonth" runat="server" class="form-control" AutoPostBack="false" Width="150px" MaxLength="150" OnSelectedIndexChanged="ddlMonth_SelectedIndexChanged">
                                            ...
                                            <div class="table-responsive" style="overflow: auto;">
                                                ...
                                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Daily-rate of wages/rate" ItemStyle-Width="50px">
                                                            <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Initial Contractor or his representative" ItemStyle-Width="50px">
                                                            <ItemTemplate>
