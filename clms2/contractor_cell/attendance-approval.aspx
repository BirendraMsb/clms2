<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="attendance-approval.aspx.cs" Inherits="clms2.contractor_cell.attendance_approval" %>
                                        ...
                                        <div class="table-responsive" style="overflow: scroll; width: 80%">
                                            ...
                                            <asp:GridView ID="GvAttn" runat="server" CssClass="gridview-container" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action By HR" ControlStyle-Width="100px">
                                                        <ItemTemplate>
                                                        ...
                                                        <EditItemTemplate>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="ddlHRApproval" ErrorMessage="Select any one" ForeColor="#CC0000" InitialValue="Select"></asp:RequiredFieldValidator>
                                                        </EditItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="HR Remarks" Visible="true">
                                                        <ItemTemplate>
