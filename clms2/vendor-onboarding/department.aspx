<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="department.aspx.cs" Inherits="clms2.vendor_onboarding.department" %>
                        ...
                        <div class="page-content-tab">
                            <div class="container-fluid">
                                ...
                                <div class="card shadow border">
                                    <div class="card-heading bg-dark text-white p-2 d-flex justify-content-between">Create Department </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <asp:TextBox ID="txtDepart" runat="server" class="form-control" MaxLength="50"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group mb-3">
