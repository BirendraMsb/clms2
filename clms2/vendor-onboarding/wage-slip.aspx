<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wage-slip.aspx.cs" Inherits="clms2.vendor_onboarding.wage_slip" %>
    ...
    <div class="container">
        ...
        <div class=" my-0 py-0 boxDec ">
            ...
            <%--<div class="d-flex">
                    ...
                    <div class="col-md-6">
                        <asp:Label ID="lblContractorNameAddr" runat="server" Text="">: </asp:Label>
                    </div>
                </div>

                <div class="d-flex">
                    <div class="col-md-6">
                        <p>Name of the workman</p>
                    </div>
                    <div class="col-md-6">
                        <asp:Label ID="lblWorkmanName" runat="server" Text="Label">: </asp:Label>
                    </div>
                </div>

                <div class="d-flex">
                    <div class="col-md-6">
                        <p>Nature and location of work </p>
                    </div>
                    <div class="col-md-6">
                        <asp:Label ID="lblWorkNature" runat="server" Text="Label">: </asp:Label>
                    </div>
                </div>
                ...
                <div class="d-flex">
                    ...
                    <div class="col-md-6">
                        <asp:Label ID="lblMonthYear" runat="server" Text="Label">: </asp:Label>
                    </div>
                </div>

                <div class="d-flex">
                    <div class="col-md-6">
                        <p>1. Number of days worked</p>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="d-flex">
                    <div class="col-md-6">
                        <p>2. Number of units worked in case of piece rate workers</p>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="d-flex">
                    <div class="col-md-6">
                        <p>3. Rate of daily wages/piece rate </p>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="d-flex">
                    <div class="col-md-6">
                        <p>4. Amount of overtime wages </p>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="d-flex">
                    <div class="col-md-6">
                        <p>7. Net amount of wages paid  </p>
                    </div>
                    <div class="col-md-6">
